...
import 'package:devfest_nashik_app/utils/tools.dart';
  ...
  child: Row(
    ...
    children: <Widget>[
      ...
      IconButton(
        ...
        onPressed: () async {
          await _launchURL("https://www.facebook.com/GDGNashik/");
        },
      ),
      ...
      IconButton(
        ...
        onPressed: () async {
          await _launchURL("https://twitter.com/gdgnashik");
        },
      ),
      ...
      IconButton(
        ...
        onPressed: () async {
          await _launchURL("https://www.instagram.com/gdgnashik/");
        },
      ),
      ...
      IconButton(
        ...
        onPressed: () async {
          await _launchURL("https://youtube.com/GDG Nashik");
        },
      ),
      ...
      IconButton(
        ...
        onPressed: () async {
          await _launchURL("https://www.meetup.com/GDG-Nashik/");
        },
      ),
    ],
  ),
